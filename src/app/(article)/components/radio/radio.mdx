...
| -------------- | ----------------------------- | ------------------------------------------------------ | ------- |
| defaultChecked | selected or not (in single)   | boolean                                                | false   |
| value          | unique ident value (in group) | string \| number                                       | -       |
| disabled       | disable current radio         | boolean                                                | false   |
| onChange       | change event                  | (event: React.ChangeEvent\<HTMLInputElement\>) => void | -       |
...
| value        | selected child radio (controlled) | string \| number                  | -       |
| disabled     | disable all radios                | boolean                           | false   |
| layout       | vertical layout                   | boolean                           | false   |
| onChange     | change event                      | (value: string \| number) => void | -       |
